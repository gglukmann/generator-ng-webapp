...
module.exports = yeoman.generators.Base.extend({
  prompting: function () {
    ...
    if (!this.options['skip-welcome-message']) {
      ...
      this.log(chalk.green('Out of the box you get Angular 1, jQuery, Bootstrap SASS, FontAwesome and a Gulp to build your app.'));
      this.log(chalk.magenta('Brought to you by Gert Glükmann & Aleks Tatter'));
    }
